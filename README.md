...
- **Split-Pane Editor** — Live rendered preview updates while you type; formatting toolbar for quick Markdown shortcuts; image drop zone
...
└── tests/              # Test suite (444 tests across 5 files)
```
