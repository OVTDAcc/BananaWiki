...
All **499 tests pass** with zero failures across six test files:

| File | Tests | What it covers |
|---|---|---|
| `test_fixes.py` | 349 | Regression cases, bug fixes, editor category access, link embedding, difficulty tag + custom tag |
